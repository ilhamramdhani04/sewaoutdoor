      ...
      <Container className="flex items-center justify-between py-3 md:py-4">
        <div className="flex items-center gap-2">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-heading text-base uppercase tracking-[0.16em] md:text-lg md:tracking-[0.2em]">
              SewaOutdoor
            </span>
          </Link>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            ...
            className={getButtonClasses(
              "primary",
              "px-4 py-2 text-xs tracking-[0.12em] md:px-6 md:py-3 md:text-sm md:tracking-[0.16em]"
            )}
          >
            Mulai Booking
          </Link>
