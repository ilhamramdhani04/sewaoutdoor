...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-canvas pb-16 pt-20 md:pb-20 md:pt-32">
      ...
      <Container className="relative">
        <div className="grid items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          >
            ...
            <h1 className="font-accent text-4xl uppercase leading-[0.95] tracking-tight text-ink sm:text-5xl md:text-7xl">
              Sewa alat camping,
              <br />
              ambil dan berangkat.
            </h1>
            <p className="max-w-xl text-base text-mute sm:text-lg">
            ...
            <div className="grid gap-3 pt-5 sm:grid-cols-3">
              {quickStats.map((stat) => (
                <div key={stat.label} className="rounded-full border border-hairline px-4 py-3">
                  <p className="font-heading text-lg text-ink sm:text-xl">{stat.value}</p>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative mx-auto max-w-xs overflow-hidden rounded-none border border-hairline bg-soft-cloud sm:max-w-sm">
              <img
